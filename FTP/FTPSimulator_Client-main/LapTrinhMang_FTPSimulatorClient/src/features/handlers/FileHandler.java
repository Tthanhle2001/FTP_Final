...
public class FileHandler implements FileBase {
    ...
    public void ClientSender(ObjectOutputStream oos, File file, String destinationPath) {
        ...
        if (file.isFile()) {
            try {
                ...
                System.err.println("Tải file lên thất bại" + ex);
    ...
    // nhỏ hơn hoặc bằng (<=) : true => được upload
    // lớn hơn : false => ko được upload
    public static boolean compareFileSize(File file, String fileSizeCompare) {
