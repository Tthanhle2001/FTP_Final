...
public class ServerUI extends javax.swing.JFrame implements Runnable {
    ...
    private DefaultTableModel tblAllUserModel;
    private DefaultTableModel tblUserOnlineModel;
...
//        loadDataUserOnline();
    ...
    private void setDefaultTableModel() {
        ...
        tblAllUserModel = (DefaultTableModel) tblAllUserView.getModel();
        
        tblAllUserModel.setColumnIdentifiers(new Object[]{
           "Email", "Tên người dùng"
        });

        tblUserOnlineModel = (DefaultTableModel) tblUserOnlineView.getModel();
        
        tblUserOnlineModel.setColumnIdentifiers(new Object[]{
           "Email", "Tên người dùng"  
        });
    ...
    private void loadDataAllUser(){
        tblAllUserModel.setRowCount(0);
        userBLL.getAllUser().forEach((user) -> {
            tblAllUserModel.addRow(new Object[]{
                user.getEmail(), user.getFullName()});
        });
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/radio.png"))); // NOI18N
        ...
        pnlMain.add(jLabel1);
        jLabel1.setBounds(40, 430, 170, 30);

        jLabel5.setFont(new java.awt.Font("Arial", 1, 13)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/user-setting.png"))); // NOI18N
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/hacker.png"))); // NOI18N
        ...
        pnlMain.add(jLabel9);
        jLabel9.setBounds(50, 330, 160, 30);

        jLabel10.setFont(new java.awt.Font("Trebuchet MS", 1, 13)); // NOI18N
        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/permission.png"))); // NOI18N
        ...
        jLabel10.setBounds(40, 240, 170, 30);
        ...
        btnUserSettingLockUpload1.setBackground(new java.awt.Color(255, 102, 0));
        ...
        btnUserSettingAllowUpload1.setBackground(new java.awt.Color(0, 153, 153));
        ...
        btnUserSettingLockUpload2.setBackground(new java.awt.Color(255, 102, 0));
        ...
        btnUserSettingAllowUpload2.setBackground(new java.awt.Color(0, 153, 153));
        ...
        jbtRefresh.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/icon-reload-35.png"))); // NOI18N
        jbtRefresh.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jbtRefreshMouseClicked(evt);
            }
        });
        ...
        pnlViewUserOnlineLayout.setHorizontalGroup(
            ...
            .addGroup(pnlViewUserOnlineLayout.createSequentialGroup()
                .addComponent(jbtRefresh, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        btnUserSettingLockUpload.setBackground(new java.awt.Color(255, 102, 0));
        ...
        btnUserSettingAllowUpload.setBackground(new java.awt.Color(0, 153, 153));
        ...
        btnUserSettingLockDownload.setBackground(new java.awt.Color(255, 102, 0));
        ...
        btnUserSettingAllowDownload.setBackground(new java.awt.Color(0, 153, 153));
                ...
                .addGroup(pnlUserSettingsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlUserSettingsLayout.createSequentialGroup()
                        .addGroup(pnlUserSettingsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(pnlUserSettingsLayout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                                .addComponent(btnUserSettingAllowDownload)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(btnUserSettingAllowUpload)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(btnUserSettingLockUpload, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(pnlUserSettingsLayout.createSequentialGroup()
                                .addGroup(pnlUserSettingsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(pnlUserSettingsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jSpinner3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 308, Short.MAX_VALUE)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnUserSettingLockDownload, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
            .addGroup(pnlUserSettingsLayout.createSequentialGroup()
                .addGap(47, 47, 47)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlUserSettingsLayout.createSequentialGroup()
                .addGroup(pnlUserSettingsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlUserSettingsLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlUserSettingsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btnUpdateCapacityUpload, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlUserSettingsLayout.createSequentialGroup()
        ...
        btnUserSettingLockUpload3.setBackground(new java.awt.Color(255, 102, 0));
        ...
        btnUserSettingAllowUpload3.setBackground(new java.awt.Color(0, 153, 153));
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/bg.png"))); // NOI18N
...
//                        System.err.println("Đã xảy ra lỗi khi unlock user download file - " + ex);
    ...
    private void jbtRefreshMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbtRefreshMouseClicked
        updateViewUserOnlineTab();
    }//GEN-LAST:event_jbtRefreshMouseClicked

    private void updateViewUserOnlineTab() {
    // Cập nhật bảng user online
    ArrayList<MembersOnline> onlineMembers = Server.getMembersOnline();
    DefaultTableModel modelOnline = (DefaultTableModel) tblUserOnlineView.getModel();
    modelOnline.setRowCount(0); // Clear bảng

    for (MembersOnline member : onlineMembers) {
        Users u = member.getUsers();
        String ip = member.getListenThread().getSocket().getInetAddress().toString();
    ...
    // Cập nhật bảng all users từ DB
    ArrayList<Users> allUsers = (ArrayList<Users>) new UserBLL().getAllUser();  // Yêu cầu UserBLL có hàm này
    DefaultTableModel modelAll = (DefaultTableModel) tblAllUserView.getModel();
